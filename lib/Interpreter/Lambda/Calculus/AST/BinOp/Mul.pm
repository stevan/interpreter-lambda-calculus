package Interpreter::Lambda::Calculus::AST::BinOp::Mul;
use Moose;
...
Interpreter::Lambda::Calculus::AST::BinOp::Mul - Lambda Calculus Interpreter in Perl

=head1 SYNOPSIS

  use Interpreter::Lambda::Calculus::AST::BinOp::Mul;
