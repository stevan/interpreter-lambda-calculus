package Interpreter::Lambda::Calculus::AST::BinOp::Gt;
use Moose;
...
Interpreter::Lambda::Calculus::AST::BinOp::Gt - Lambda Calculus Interpreter in Perl

=head1 SYNOPSIS

  use Interpreter::Lambda::Calculus::AST::BinOp::Gt;
