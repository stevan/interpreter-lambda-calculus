package Interpreter::Lambda::Calculus::AST::BinOp::Div;
use Moose;
...
Interpreter::Lambda::Calculus::AST::BinOp::Div - Lambda Calculus Interpreter in Perl

=head1 SYNOPSIS

  use Interpreter::Lambda::Calculus::AST::BinOp::Div;
