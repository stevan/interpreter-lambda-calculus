package Interpreter::Lambda::Calculus::AST::BinOp::Eq;
use Moose;
...
Interpreter::Lambda::Calculus::AST::BinOp::Eq - Lambda Calculus Interpreter in Perl

=head1 SYNOPSIS

  use Interpreter::Lambda::Calculus::AST::BinOp::Eq;
