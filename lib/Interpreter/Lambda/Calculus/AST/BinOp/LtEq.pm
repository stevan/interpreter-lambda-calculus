package Interpreter::Lambda::Calculus::AST::BinOp::LtEq;
use Moose;
...
Interpreter::Lambda::Calculus::AST::BinOp::LtEq - Lambda Calculus Interpreter in Perl

=head1 SYNOPSIS

  use Interpreter::Lambda::Calculus::AST::BinOp::LtEq;
